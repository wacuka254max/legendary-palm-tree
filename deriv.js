...
(function (global) {
   ...
   * offer by itself, so getting Uptick onto a phone stops depending on anybody
  ...
  function markFirstConnect() {
    try {
      if (!localStorage.getItem(SESSION_KEY)) localStorage.setItem("uptick_install_on_connect", "1");
